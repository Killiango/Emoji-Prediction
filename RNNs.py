...
class GRU_NET():
    ...
    embedding_dim = 300
     ...
     def __init__(self, vocab_size: int, hidden_units: int, n_features: int, n_timesteps, labels_dim: int, dropout = False, optimizer):
        ...
        self.model.add(TimeDistributed(Dense(self.labels_dim, activation = 'softmax')))
